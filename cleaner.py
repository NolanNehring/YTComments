...
def remove_inside_braces(text):
    # Remove text inside parentheses or square brackets
...
def remove_words_start_with(text, starts_with_char):
    ...
    """
    for char in starts_with_char:
        # Convert char to a string before concatenating with the pattern
        pattern = r'\b' + str(char) + r'[A-Za-z0-9\w]*\b'
